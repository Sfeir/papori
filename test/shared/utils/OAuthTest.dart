...
class OAuthTest implements Runnable {
  run() {
    ...
    test('hashSignature', () {
      ...
      String consumerKey = 'kAcSOqF21Fu85e7zjz7ZN2U4ZRhfV3WpwPAoE3Z7kBw';
      String token = 'LswwdoUaIvS8ltyTt5jkRh4J50vUPVVHtR2YPi5kE';
      
      String output = OAuth.hashSignature(baseSignature, consumerKey, token);
    ...
    test('hashSignature', () {
      ...
      String consumerKey = 'abc&123';
      
      String output = OAuth.hashSignature(baseSignature, consumerKey);
